...
<section class="bg-[#101010] text-white py-24 md:py-32 relative z-20 border-t border-white/5">
  <div class="max-w-7xl mx-auto px-6 lg:px-16">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[280px] md:auto-rows-[320px]">
      
      <div class="md:col-span-2 bg-[#1A1A1A] rounded-[2rem] p-8 md:p-10 border border-white/5 relative overflow-hidden group hover:border-white/10 transition-colors">
        ...
        <div class="relative z-10 h-full flex flex-col justify-between">
          <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="text-gray-400 mb-4"><path d="M6 16v-2a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v2"/><path d="M12 4v4"/><circle cx="12" cy="10" r="2"/></svg>
          <div>
      ...
      <div class="bg-[#1A1A1A] rounded-[2rem] p-8 md:p-10 border border-white/5 relative overflow-hidden group hover:border-white/10 transition-colors flex flex-col justify-between">
      ...
      <div class="md:col-span-2 bg-[#1A1A1A] rounded-[2rem] p-8 md:p-10 border border-white/5 relative overflow-hidden group hover:border-white/10 transition-colors">
        ...
        <div class="relative z-10 h-full flex flex-col justify-between">
          <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="text-gray-400 mb-4"><rect width="18" height="18" x="3" y="3" rx="2"/><path d="M3 9h18"/><path d="M9 21V9"/></svg>
          <div>
